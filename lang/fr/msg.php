...
return
    [
        ...
        'card_add_ok'=>'Le produit à été ajouter à votre panier',
        'card_update_ok'=>'votre panier a été modifié avec success',
        'card_del_ok'=>'Produit retiré du panier',
        'check_account_state'=>'votre compte est désactivé',
        'user_invalid' => 'Both Username and Email cannot be blank',
        'update_ok' => 'Modification effectuée avec succès',
        'store_ok' => 'Record Created Successfully',
        'store_already_exists' => "L'enregistrement existe déjà",
        ...
        'time_slot_occupied' => 'Cette plage horaire est déjà occupée',
        // Mes ajouts
        'language' => 'Français',
    ];
