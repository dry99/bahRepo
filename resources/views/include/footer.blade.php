                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                    <div class="single-footer-caption mb-30">
                        ...
                        <div class="footer-logo">
                            <a href="index.html"><img src="{{asset('marian/assets/img/logo/logo2_footer.png')}}" alt=""></a>
                        </div>
                        ...
                        <div class="footer-pera">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                ...
                                This template is made with <i class="ti-heart" aria-hidden="true"></i> by <a
                                    href="{{asset('https://colorlib.com')}}" target="_blank">Colorlib</a>
                                        ...
                                        <div class="form-icon">
                                            <button type="submit" name="submit" id="newsletter-submit"
                                                class="email_icon newsletter-submit button-contactForm"><img
                                                    src="{{asset('marien/assets/img/logo/form-iocn.jpg')}}" alt=""></button>
                                        </div>
